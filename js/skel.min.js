...
var skel = (function () {
    var _ = {
        ...
        presets: {
            default: {},
            standard: { breakpoints: { mobile: { range: "-480", lockViewport: !0, containers: "fluid", grid: { collapse: 1, gutters: 10 } }, desktop: { range: "481-", containers: 1200 }, "1000px": { range: "481-1200", containers: 960 } } },
        },
            ...
            if (!_[i][r][_[n]]) {
                ...
                if (!(q = _[a](R))) {
                    ...
                    (V = W * 0.75 + X),
                        ...
                        (q = _[f](
                            R,
                            _[l]("body{min-width:" + $ + x + ".container{margin-left:auto;margin-right:auto;width:" + $ + x + ".container.small{width:" + V + x + ".container.big{width:100%;max-width:" + J + ";min-width:" + $ + x),
                            c,
                            3
                        ));
                }
                F[p][h](q),
                    ...
                    (q = _[a](R)) ||
                        (q = _[f](
                            R,
                            _[l](".row>*{float:left;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}.row:after{content:'';display:block;clear:both;height:0}.row:first-child>*{padding-top:0!important}"),
                            c,
                            3
                        )),
                    F[p][h](q),
        ...
        initAPI: function () {
            ...
            (_[e].IEVersion = u[t](/MSIE ([0-9]+)\./) ? RegExp.$1 : 99),
                (_[e][n] = "other"),
                (o = { ios: "(iPad|iPhone|iPod)", android: "Android", mac: "Macintosh", wp: "Windows Phone", windows: "Windows NT" }),
